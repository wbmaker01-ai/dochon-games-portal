...
- `pirateCoinNetwork.js`: 도촌초 전용 Firebase RTDB 기반 WebRTC 시그널링 + W3C Native RTCDataChannel P2P 실시간 멀티플레이어 동기화 매니저
...
5. **Firebase RTDB WebRTC 시그널링**: 외부 무료 PeerJS 클라우드 의존성을 배제하고, 도촌초 전용 Firebase RTDB 인스턴스를 활용하여 안정적인 연결 및 10ms 초저지연 P2P 달성.
