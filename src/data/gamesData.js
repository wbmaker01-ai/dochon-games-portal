...
export const PLAYABLE_GAMES = [
  {
    id: 'pacman',
    title: '도촌 팩맨',
    englishTitle: 'DOCHON PAC-MAN',
    category: '클래식',
    imageSrc: getThumb('pacman.jpg'),
    iconEmoji: '🟡',
    themeGradient: 'linear-gradient(135deg, #FBBF24, #F59E0B)',
    scoreUnit: '점',
    releaseOrder: 1,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'dino',
    title: '도촌 공룡 달리기',
    englishTitle: 'DOCHON DINO RUN',
    category: '액션',
    imageSrc: getThumb('dino.jpg'),
    iconEmoji: '🦖',
    themeGradient: 'linear-gradient(135deg, #34D399, #10B981)',
    scoreUnit: 'm',
    releaseOrder: 2,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'snake',
    title: '도촌 스네이크',
    englishTitle: 'DOCHON SNAKE MASTER',
    category: '클래식',
    imageSrc: getThumb('snake.jpg'),
    iconEmoji: '🐍',
    themeGradient: 'linear-gradient(135deg, #10B981, #059669)',
    scoreUnit: '점',
    releaseOrder: 3,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'minesweeper',
    title: '도촌 지뢰찾기',
    englishTitle: 'DOCHON MINESWEEPER',
    category: '퍼즐',
    imageSrc: getThumb('minesweeper.jpg'),
    iconEmoji: '💣',
    themeGradient: 'linear-gradient(135deg, #10B981, #047857)',
    scoreUnit: '점',
    releaseOrder: 5,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'baseball',
    title: '도촌 야구왕',
    englishTitle: 'DOCHON BASEBALL KING',
    category: '스포츠',
    imageSrc: getThumb('baseball.jpg'),
    iconEmoji: '⚾',
    themeGradient: 'linear-gradient(135deg, #38BDF8, #0284C7)',
    scoreUnit: '점',
    releaseOrder: 6,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'colortile',
    title: '도촌 컬러 타일',
    englishTitle: 'DOCHON COLOR TILE',
    category: '퍼즐',
    imageSrc: getThumb('colortile.jpg'),
    iconEmoji: '🧩',
    themeGradient: 'linear-gradient(135deg, #EC4899, #8B5CF6)',
    scoreUnit: '점',
    releaseOrder: 7,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'gnome',
    title: '도촌 정원 요정',
    englishTitle: 'DOCHON GARDEN GNOMES',
    category: '액션',
    imageSrc: getThumb('gnome.jpg'),
    iconEmoji: '🌿',
    themeGradient: 'linear-gradient(135deg, #48BB78, #2F855A)',
    scoreUnit: 'm',
    releaseOrder: 8,
    isNew: false,
    isPlayable: true,
    badgeText: '🌿 8위',
    description: '새총으로 정원 요정을 날려 클로버와 무지개를 타고 날아가는 슬링샷 플라이트!'
  },
  {
    id: 'popcorn',
    title: '도촌 팝콘',
    englishTitle: 'DOCHON POPCORN SURVIVAL',
    category: '액션',
  ...
  },
  {
    id: 'tictactoe',
    title: '도촌 도넛 틱택토',
    englishTitle: 'DONUT TIC-TAC-TOE',
    category: '퍼즐',
    imageSrc: getThumb('donut-tictactoe.jpg'),
    iconEmoji: '🍩',
    themeGradient: 'linear-gradient(135deg, #F472B6, #FB7185)',
    scoreUnit: '점',
    releaseOrder: 10,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'ponyexpress',
    title: '도촌 포니 익스프레스',
    englishTitle: 'PONY EXPRESS',
    category: '액션',
    imageSrc: getThumb('ponyexpress.jpg'),
    iconEmoji: '🐎',
    themeGradient: 'linear-gradient(135deg, #D97706, #B45309)',
    scoreUnit: '점',
    releaseOrder: 13,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'jerrylawson',
    title: '도촌 제리 로슨',
    englishTitle: 'JERRY LAWSON',
    category: '액션',
    imageSrc: getThumb('jerrylawson.jpg'),
    iconEmoji: '🕹️',
    themeGradient: 'linear-gradient(135deg, #8B5CF6, #6D28D9)',
    scoreUnit: '점',
    releaseOrder: 14,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'magic',
    title: '도촌 매직 캣 아카데미',
    englishTitle: 'MAGIC CAT ACADEMY',
    category: '어드벤처',
    imageSrc: getThumb('magic.jpg'),
    iconEmoji: '🧙',
    themeGradient: 'linear-gradient(135deg, #9333EA, #4F46E5)',
    scoreUnit: '점',
    releaseOrder: 15,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'fruitmerge',
    title: '도촌 과일 합치기',
    englishTitle: 'DOCHON FRUIT MERGE',
    category: '퍼즐',
    imageSrc: getThumb('fruitmerge.jpg'),
    iconEmoji: '🍉',
    themeGradient: 'linear-gradient(135deg, #10B981, #EF4444)',
    scoreUnit: '점',
    releaseOrder: 16,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'brickbreaker',
    title: '도촌 벽돌 격파왕',
    englishTitle: 'DOCHON BRICK BREAKER',
    category: '액션',
    imageSrc: getThumb('brickbreaker.jpg'),
    iconEmoji: '🧱',
    themeGradient: 'linear-gradient(135deg, #0284C7, #0369A1)',
    scoreUnit: '점',
    releaseOrder: 17,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'skyjumper',
    title: '도촌 스카이 점퍼',
    englishTitle: 'DOCHON SKY JUMPER',
    category: '액션',
    imageSrc: getThumb('skyjumper.jpg'),
    iconEmoji: '🚀',
    themeGradient: 'linear-gradient(135deg, #0EA5E9, #6366F1)',
    scoreUnit: '점',
    releaseOrder: 18,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'kidscoding',
    title: '도촌 코딩 토끼',
    englishTitle: 'DOCHON KIDS CODING',
    category: '퍼즐',
    imageSrc: getThumb('kidscoding.jpg'),
    iconEmoji: '🥕',
    themeGradient: 'linear-gradient(135deg, #10B981, #3B82F6)',
    scoreUnit: '점',
    releaseOrder: 19,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'bubbletea',
    title: '도촌 버블티 카페',
    englishTitle: 'DOCHON BUBBLE TEA CAFE',
    category: '액션',
    imageSrc: getThumb('bubbletea.jpg'),
    iconEmoji: '🧋',
    themeGradient: 'linear-gradient(135deg, #F59E0B, #8B5CF6)',
    scoreUnit: '점',
    releaseOrder: 20,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'pizza',
    title: '도촌 피자 마스터',
    englishTitle: 'DOCHON PIZZA MASTER',
    category: '퍼즐',
  ...
  },
  {
    id: 'earthbee',
    title: '도촌 꿀벌의 비행',
    englishTitle: 'DOCHON EARTH BEE',
    category: '액션',
    imageSrc: getThumb('earthbee.jpg'),
    iconEmoji: '🐝',
    themeGradient: 'linear-gradient(135deg, #FBBF24, #10B981)',
    scoreUnit: '점',
    releaseOrder: 22,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'olympics',
    title: '도촌 미니 올림픽',
    englishTitle: 'DOCHON MINI OLYMPICS',
    category: '스포츠',
  ...
  },
  {
    id: 'pangolin',
    title: '도촌 천산갑의 모험',
    englishTitle: 'PANGOLIN ADVENTURE',
    category: '어드벤처',
    imageSrc: getThumb('pangolin.jpg'),
    iconEmoji: '🦔',
    themeGradient: 'linear-gradient(135deg, #D97706, #78350F)',
    scoreUnit: '점',
    releaseOrder: 24,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'roswell',
    title: '도촌 UFO 탈출작전',
    englishTitle: 'DOCHON ROSWELL',
    category: '어드벤처',
    imageSrc: getThumb('roswell.jpg'),
    iconEmoji: '🛸',
    themeGradient: 'linear-gradient(135deg, #8B5CF6, #06B6D4)',
    scoreUnit: '점',
    releaseOrder: 25,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'petanque',
    title: '도촌 페탕크 마스터',
    englishTitle: 'DOCHON PETANQUE',
    category: '스포츠',
    imageSrc: getThumb('petanque.jpg'),
    iconEmoji: '⚪',
    themeGradient: 'linear-gradient(135deg, #64748B, #475569)',
    scoreUnit: '점',
    releaseOrder: 26,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'halfmoon',
    title: '반달 (Half Moon)',
    englishTitle: 'DOCHON HALF MOON',
    category: '카드',
    imageSrc: getThumb('halfmoon.jpg'),
    iconEmoji: '🌓',
    themeGradient: 'linear-gradient(135deg, #3B82F6, #1E1B4B)',
    scoreUnit: '점',
    releaseOrder: 27,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    ...
    englishTitle: 'DOCHON PANI PURI',
    category: '퍼즐',
    imageSrc: getThumb('panipuri.jpg'),
    iconEmoji: '🫓',
    themeGradient: 'linear-gradient(135deg, #EAB308, #D97706)',
    scoreUnit: '점',
    releaseOrder: 28,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'memory',
    title: '도촌 기억력 마스터',
    englishTitle: 'DOCHON MEMORY MASTER',
    category: '퍼즐',
    imageSrc: getThumb('memory.jpg'),
    iconEmoji: '🧠',
    themeGradient: 'linear-gradient(135deg, #A855F7, #EC4899)',
    scoreUnit: '점',
    releaseOrder: 29,
    isNew: false,
    isPlayable: true,
  ...
  },
  {
    id: 'ghoulduel',
    title: '도촌 영혼 대결',
    englishTitle: 'DOCHON GHOUL DUEL',
    category: '멀티',
    imageSrc: getThumb('ghoulduel.jpg'),
    iconEmoji: '👻',
    themeGradient: 'linear-gradient(135deg, #10B981, #8B5CF6)',
    scoreUnit: '점',
    releaseOrder: 30,
    isNew: true,
    isPlayable: true,
  ...
  },
  {
    id: 'schooltag',
    title: '도촌 야간 학교 숨바꼭질',
    englishTitle: 'DOCHON SCHOOL TAG',
    category: '멀티',
    imageSrc: getThumb('schooltag.jpg'),
    iconEmoji: '🔦',
    themeGradient: 'linear-gradient(135deg, #6366F1, #9333EA)',
    scoreUnit: '점',
    releaseOrder: 32,
    isNew: true,
    isPlayable: true,
